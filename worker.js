...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .login-box, .app-box { background: #161b22; border: 1px solid #30363d; border-radius: 16px; padding: 32px; }
    .login-box h1, .app-box h1 { font-size: 24px; margin-bottom: 8px; text-align: center; }
    .login-box .sub, .app-box .sub { text-align: center; color: #8b949e; margin-bottom: 24px; }
    .login-box input { width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #30363d; background: #0d1117; color: #e6edf3; font-size: 16px; margin-bottom: 12px; outline: none; }
    .login-box input:focus { border-color: #58a6ff; }
    .login-box button { width: 100%; padding: 10px; border: none; border-radius: 8px; background: #238636; color: white; font-weight: 600; font-size: 16px; cursor: pointer; }
    .login-box button:hover { background: #2ea043; }
    .login-box .error { color: #f85149; margin-top: 12px; display: none; text-align: center; }
    ...
    .logout-btn { background: #21262d; border: 1px solid #30363d; color: #8b949e; padding: 4px 12px; border-radius: 6px; cursor: pointer; float: right; font-size: 14px; }
...
let token = localStorage.getItem('ocr_token') || null;
...
loginBtn.onclick = async () => {
  ...
  if (!user || !pass) { loginError.textContent = '请输入用户名和密码'; loginError.style.display = 'block'; return; }
